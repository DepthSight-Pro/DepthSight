...
interface CustomAssetTooltipProps {
	active?: boolean;
	payload?: Array<{ payload?: { ticker: string; pnl: number } }>;
}

const CustomAssetTooltip = ({ active, payload }: CustomAssetTooltipProps) => {
